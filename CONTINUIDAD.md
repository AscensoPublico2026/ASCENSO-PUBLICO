...
> - El **material/banco de preguntas** que define qué se evalúa lo pegó el usuario en el chat de la sesión anterior (Convocatoria Antioquia 3). Falta crear el JSON; el sub-agente que lo intentaba se abortó.
