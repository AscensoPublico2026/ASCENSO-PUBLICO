...
export default async function CrearClientePage() {
  ...
  // Cargar convocatorias activas para el select
  ...
  return (
    <main style={{ maxWidth: 680, margin: "0 auto", padding: "40px 22px" }}>
      <Link href="/admin" style={{ color: "var(--texto-suave)", fontSize: ".9rem" }}>
        ← Panel
      </Link>
      ...
      <p style={{ color: "var(--texto-suave)", marginBottom: 28, fontSize: ".92rem" }}>
        Crea un perfil y curso sin pasar por la pasarela de pagos. Ideal para pagos por
        transferencia, consignación o efectivo.
      </p>
