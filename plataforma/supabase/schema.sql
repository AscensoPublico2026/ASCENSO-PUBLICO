...
create table if not exists public.cursos (
  ...
  convocatoria_id uuid references public.convocatorias(id),
  opec text,
  numero_inscripcion text,             -- número de inscripción asignado por la CNSC al candidato
  cargo_nombre text,
  nivel text,
...
-- ============================================================
-- Migraciones incrementales (ejecutar en bases ya existentes)
-- ============================================================

-- v2: número de inscripción CNSC del candidato (campo manual, lo agrega el admin)
