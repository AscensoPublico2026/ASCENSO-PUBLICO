...
| Campo | Dato |
|-------|------|
| Nombre | Tatiana (apellidos pendientes) |
| Formación | Un **técnico** — ⚠️ "terminó siendo el técnico que es para trabajo" → probablemente **Técnico Laboral por Competencias (ETDH), NO educación superior**. VERIFICAR con el diploma. |
| Cargo objetivo | Auxiliar administrativo o Técnico operativo (o cualquiera al que pueda aplicar) |
| Salario aspirado | $4.000.000 – $5.000.000 |
| Ciudades de interés | Cartagena (principal) · quizás Barranquilla o Medellín |
| ¿Traslado? | Sí, a ciudades principales |
| ¿Concursos anteriores? | Pendiente |

## 2. ⚠️ Punto clave a verificar (REGLA DE ORO)
- Si el técnico es **Laboral por Competencias / ETDH** (como el caso de Alejandra Zúñiga) → **NO es educación superior**.
  Entonces NO cumple cargos que pidan "X años de educación superior"; solo los que pidan **bachiller / bachiller+curso** + experiencia.
- Si fuera **Técnico Profesional o Tecnólogo (educación superior)** → se abren cargos Técnico administrativo, etc.
- La experiencia certificada define los cargos que exijan experiencia relacionada.
...
- **Experiencia ADMINISTRATIVA en el Estado (~8-9 años):**
  ...
  - Gobernación San Andrés — Auxiliar Administrativo 407-24 (PROPIEDAD/carrera): 01/02/2022 – actual (~4a 7m)
  → mucha experiencia relacionada, cumple topes de 1-1.5 años de sobra.
- Documentación: cédula, acta bachiller, título+notas SENA, 2 cert. laborales con funciones, cursos, cert. electoral, OCCRE (San Andrés). Completa.

## 4. ⚠️ REGLA DE ORO — el técnico SENA NO es educación superior
- **NO cumple** cargos que pidan "X años de educación superior" (242, 289, 288, 262…) → DESCARTADOS.
- **SÍ cumple** cargos que pidan **bachiller** o **bachiller + curso** + experiencia (los tiene todos).

## 5. OPCIONES que CUMPLE 100% (bachiller + exp + cursos) — verificadas con manual
| Código | Cargo (Grado) | Salario | Estudio exigido | Total | En sus ciudades | ¿Cumple? |
|--------|---------------|--------:|-----------------|:---:|-----------------|:---:|
| **244** | Auxiliar administrativo (5AM-08) | $4.183.546 | Diploma de bachiller | 6 | **Cartagena 1**, Antioquia 1 | ✅ (bachiller + 1 año exp) |
