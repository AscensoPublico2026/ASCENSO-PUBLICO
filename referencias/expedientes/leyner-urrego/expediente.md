# 🗂️ Expediente — Leyner Andrés Urrego Sanmartín

> Concurso: Procuraduría General de la Nación (PGN) 2026
> Asesor: Juan Gómez (Ascenso Público) · Operado por: Laurita
> Estado: **PASO 4 completado — documentación leída al 100%. Falta análisis de vacantes.**
...
| Campo | Dato |
|-------|------|
| Nombre | Leyner Andrés Urrego Sanmartín |
| C.C. | 1.017.273.025 (nacido 14/08/1999 — 26 años, Urrao–Antioquia) |
| Profesión | **Contador Público** (Instituto Tecnológico Metropolitano – ITM, Medellín) |
| Fecha de grado (título) | **27 de julio de 2023** (Acta N° 82 de 2023) |
| Tarjeta profesional | **N° 332769-T** — Junta Central de Contadores (inscripción 08/10/2024) ✅ |
| Cargo actual | Contador en BIO URBE S.A.S. (líder de área) |
| Posgrado | Especialización en Legislación Tributaria — **EN CURSO** (terminaría en ~2 meses). ❗ AÚN NO TITULADO |
| Ciudad actual | Medellín — vota en Medellín ✅ |
| **Salario aspirado** | **$6.000.000 – $8.000.000** (o un poco más) |
| Ciudades de interés | Abierto a cualquiera |
| Departamentos de interés | Risaralda, Quindío, Valle del Cauca, Antioquia, Meta, Boyacá |
| ¿Cambia de ciudad? | Sí |
...
|--------|-------------|-------------|-------|
| Bachiller | (acta aportada) | — | ✅ documento presente |
| **Contador Público** | ITM (Medellín) | **27/07/2023** | ✅ Acta 82/2023. **Fecha base de experiencia** |
| Especialización Legislación Tributaria | (en curso) | **NO graduado** | ❗ No cuenta como posgrado hasta obtener el título |

## 3. Experiencia laboral (verificada) y cálculo POST-TÍTULO

> Regla: experiencia profesional cuenta desde el título de contador (27/07/2023).

| Entidad | Cargo | Periodo | ¿Cuenta? |
|---------|-------|---------|:--------:|
| BIO URBE S.A.S. | Contador (líder de área) — NIIF, estados financieros, impuestos, nómina, CxP/CxC, licitaciones | 05/08/2024 → a la fecha (certif. 08/09/2026) | ✅ post-título |

### 🧮 TOTAL experiencia profesional post-título: **~2 años y 1 mes** (05/08/2024 → 08/09/2026 ≈ 25 meses)

> ⚠️ **Ojo con la experiencia:** solo aporta **UN** certificado laboral (BIO URBE, desde ago-2024). Entre el grado (jul-2023) y ago-2024 hay ~1 año sin certificar. Si trabajó en ese lapso (o antes/durante, como practicante o en otra empresa), **pedir esos certificados** para sumar experiencia. Hoy cuenta con **~2 años** certificados post-título.

## 4. TABLA DE ANÁLISIS DE DOCUMENTACIÓN

| # | Documento | ¿Está? | Detalle | Obs. |
|---|-----------|:------:|---------|------|
| 1 | Cédula | ✅ | C.C. 1.017.273.025 | Legible |
| 2 | Acta bachiller | ✅ | Presente | — |
| 3 | Acta grado profesional (Contador) | ✅ | ITM, 27/07/2023 | ✅ |
| 4 | Certificado laboral | ✅ | BIO URBE, Contador, desde 05/08/2024, con funciones | ✅ |
| 5 | Certificados de votación | ✅ | 3 (mar/may/jun 2026), Medellín | ✅ da puntaje |
| 6 | Tarjeta profesional Contador | ✅ | N° 332769-T (JCC) | ✅ |

### 🔧 Pendientes / recomendaciones de documentación
1. ❗ **Especialización EN CURSO:** aún no titulada → **no sirve para cargos que exijan posgrado** hasta que se gradúe y tenga acta/diploma. Si alcanza a titularse antes de acreditar requisitos, se abren cargos de mayor nivel/salario. **Pedirle**: constancia de estudios / fecha estimada de grado.
2. ⚠️ **Más experiencia:** hoy solo hay ~2 años certificados (BIO URBE desde ago-2024). Si trabajó entre jul-2023 y ago-2024 (o tiene otros empleos), **pedir esos certificados** con fechas y funciones para robustecer el requisito de experiencia.
3. ⚠️ **Certificado de vigencia de la tarjeta profesional** (Junta Central de Contadores): conviene tenerlo para el registro (se descarga en línea).
4. ✅ El resto está completo y legible.

## 5. Lectura estratégica para vacantes (preliminar)

- Perfil **CONTABLE/FINANCIERO** con **tarjeta profesional** y **~2 años** de experiencia post-título.
- ❗ **Filtrar cargos que acepten CONTADURÍA PÚBLICA** (no los de "solo derecho").
