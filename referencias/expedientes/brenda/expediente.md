...
| Campo | Dato |
|-------|------|
| Nombre | Brenda (apellidos pendientes) |
| C.C. | Pendiente |
...
## 3. Siguiente paso
Tras leer la documentación: perfil + análisis de matriz (nivel y salario según su formación,
ciudades de interés), tabla ordenada de menor a mayor salario con plazas totales + desglose por
ciudad de interés, y selección de manuales para el cruce final.
